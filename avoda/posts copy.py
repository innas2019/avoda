...
def create_post(n_post):
    new_post= Posts(created=n_post.created,updated=n_post.updated,name=n_post.name,
            place=n_post.place, phone=n_post.phone, text=n_post.text,len=json.dumps(n_post.len),
            occupations=str(n_post.occupations),o_kind=str(n_post.o_kind),sex= n_post.sex)
